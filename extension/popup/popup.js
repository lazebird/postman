...
function renderSessionStatus(status) {
  ...
  const sid163Badge = sid163 ? '<span class="sid-chip sid-ok">✅ 已授权</span>' : '<span class="sid-chip sid-no">❌ 未授权</span>';
  const sidQQBadge = sidQQ ? '<span class="sid-chip sid-ok">✅ 已授权</span>' : '<span class="sid-chip sid-no">❌ 未授权</span>';
